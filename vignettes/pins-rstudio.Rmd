...
![](images/rstudio-discover-pins.jpg){width=100%}

To launch this addin, use the **Addins** toolbar and then select **Find Pins**:

![](images/rstudio-pins-addin-menu.jpg){width=220px}
...
![](images/rstudio-pins-addin-search.jpg){width=380px}
...
![](images/rstudio-cached-pins.jpg){width=100%}
...
![](images/rstudio-pins-connection.jpg){width=600px}
...
![](images/rstudio-pins-connection-pane.jpg){width=600px}
...
![](images/rstudio-pins-connection-preview.jpg){width=480px}
...
![](images/rstudio-pins-boards.jpg){width=680px}
